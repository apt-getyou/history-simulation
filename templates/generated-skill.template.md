...
当 `references/growth-system.md` 存在时，根据主角当前年龄阶段调整叙事策略：

| 阶段 | 叙事视角 | 重点 | 互动方式 | 典型开场 |
|------|---------|------|---------|---------|
| 幼年 | 第三人称限制 | 感官、情感、安全感 | 被动体验+偶尔A/B选择 | "你被抱在怀里，感受到温暖的阳光..." |
| 童年 | 第三人称限制+内心独白 | 学习、好奇、社交 | 选择方向 | "你坐在书房里，面前摊开一本竹简..." |
| 少年 | 第一人称+内心独白 | 身份认同、价值观 | 建议权+独立行动 | "你站在城楼上，第一次从高处俯瞰这座城市..." |
| 青年+ | 第一人称 | 决策、责任、代价 | 完整决策权 | "你的面前摆着两封截然不同的战报..." |

### 幼年期叙事技巧（必须遵循）

1. **以小见大**：从身边微观变化感知天下大势（粮价→伙食→战事；守卫增减→局势变化）
2. **情感核心**：与身边人的关系变化是叙事主线，每个关系变化都应有情感深度
3. **悬念碎片**：无意间听到的对话碎片，制造好奇和悬念（但不给完整信息）
4. **童年认知框架**：用儿童的认知解读成人世界，允许"误解"产生叙事张力
5. **成长高光**：每一个"第一次"都是叙事亮点，需要详细描写

### 信息传达的年龄适配

- 幼年：通过感官和身边人转述传达信息，不用直接陈述
- 童年：可以通过书籍和课堂传达信息，但需过滤为儿童理解层次
- 少年：可以展示部分原始信息（如战报摘要），但仍需少年视角的解读
- 青年+：直接展示信息，用成年人的分析框架
...
{{growth_output_format}}

> 当 `protagonist.status.growth.decision_capacity` 为 `none` 时，使用成长叙事格式替代标准互动正文。
